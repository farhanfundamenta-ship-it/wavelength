    ...
    <Section tone="paper" className="overflow-hidden">
      <Container>
        ...
        <div className="mt-6 grid grid-cols-1 gap-x-8 gap-y-14 md:grid-cols-12 md:gap-y-0">
          ...
          <div className="reveal md:col-span-7 md:pr-6">
            <h2 className="max-w-2xl text-4xl font-semibold leading-[1.02] tracking-tight text-heading sm:text-5xl lg:text-6xl">
              ...
              <span className="text-accent-deep"> lower-carbon </span>
              world.
            </h2>
          ...
          <div className="md:col-span-5 md:pt-28 md:pl-6">
            <div className="reveal border-t border-heading/80 pt-6">
              ...
              >
                ...
                <Icon
                  name="arrowRight"
                  className="h-4 w-4 text-accent-deep transition-transform duration-300 group-hover:translate-x-1"
                />
              </a>

              {/* Supporting image #1, tucked under the copy */}
              <figure className="reveal-img mt-12 hidden md:block">
        ...
        <div className="relative mt-16 grid grid-cols-1 gap-x-8 gap-y-12 md:mt-8 md:grid-cols-12">
          ...
          <figure className="reveal-img md:col-span-5 md:-mt-24">
          ...
          <div className="reveal md:col-span-7 md:self-end md:pl-6">
